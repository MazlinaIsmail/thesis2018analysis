...
#hv_dir = '/Volumes/BF_MI_1/cvid-analysis/hv_freq_chainchud_agematch/'
...
plt.xlabel('Proportion (total abundance)')
plt.tight_layout()
#plt.show()
today_date = datetime.datetime.now()
plt.savefig("%s-%s-%s_" %(today_date.year, today_date.month, today_date.day)+str(sys.argv[2])+"-TotalProp-HVvsID.png", dpi=600)
